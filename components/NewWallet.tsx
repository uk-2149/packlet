...
const NewWallet: React.FC<NewWalletProps> = ({ mnemonic }) => {
  ...
  return (
    <div>
        <div className="border border-gray-800 rounded-xl p-6 shadow-2xl bg-gray-800 mb-6 w-full">
              <div
                onClick={handleShowPhrase}
                className="cursor-pointer p-4 mb-4 font-bold text-3xl text-white hover:text-blue-400 transition-colors duration-200 flex justify-between"
              >
                Your Secret Phrase{" "}
